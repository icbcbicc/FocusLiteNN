% This Matlab version is only for the purpose of exactly reproducing the results of the PyTorch version,
% such that the efficiency of this Matlab code is not taken into condiseration.

clear;
clc;

load("FocusLiteNN1channel.mat");

im_name = "../Slide01_Strip00_Slice01_Position21.png";
